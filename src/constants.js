...
export const IPC_MANY_FILE_CONTENT_REQUEST = "manyFileContent:request";
export const IPC_MANY_FILE_CONTENT_SUCCESS_RESPONSE = "manyFileContent:response_success";
export const IPC_MANY_FILE_CONTENT_FAILURE_RESPONSE = "manyFileContent:response_failure";
